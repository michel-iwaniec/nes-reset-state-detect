...
The example demo included will upload a nametable showing labels for sprite#0 hit/miss bit patterns of different tests being run, and the detected system / phase.
